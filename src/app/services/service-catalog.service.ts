...
export class ServiceCatalogService {
  ...
  private loadServicesFromBackend(): void {
    ...
    this.http.get<ServiceCatalog[]>(`${ApiConfig.API_BASE_URL}/api/services`)
      .pipe(
        catchError(error => {
  ...
  reloadServices(): Observable<ServiceCatalog[]> {
    return this.http.get<ServiceCatalog[]>(`${ApiConfig.API_BASE_URL}/api/services`)
      .pipe(
  ...
  createService(serviceData: CreateServiceRequest): Observable<ServiceCatalog> {
    return this.http.post<{service: ServiceCatalog}>(`${ApiConfig.API_BASE_URL}/api/services`, serviceData)
      .pipe(
  ...
  updateService(id: number, serviceData: UpdateServiceRequest): Observable<ServiceCatalog> {
    return this.http.put<ServiceCatalog>(`${ApiConfig.API_BASE_URL}/api/services/${id}`, serviceData)
      .pipe(
  ...
  deleteService(id: number): Observable<boolean> {
    return this.http.delete<{message: string}>(`${ApiConfig.API_BASE_URL}/api/services/${id}`)
      .pipe(
        map(() => true),
        tap(() => {
          // Actualizar la lista local
