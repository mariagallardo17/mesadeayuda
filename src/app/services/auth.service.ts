...
export class AuthService {
  ...
  login(credentials: LoginRequest): Observable<LoginResponse> {
    return this.http.post<LoginResponse>(`${ApiConfig.API_BASE_URL}/api/auth/login`, {
  ...
  changePassword(request: ChangePasswordRequest): Observable<{ message: string }> {
    ...
    return this.http.post<{ message: string }>(`${ApiConfig.API_BASE_URL}/api/auth/change-password`, {
  ...
  changeTemporaryPassword(newPassword: string): Observable<{ message: string }> {
    ...
    return this.http.post<{ message: string }>(`${ApiConfig.API_BASE_URL}/api/auth/change-temporary-password`, {
  ...
  recuperarPassword(email: string): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${ApiConfig.API_BASE_URL}/api/auth/forgot-password`, {
      correo: email
    }).pipe(
