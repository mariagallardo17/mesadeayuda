...
export class ProfileComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    console.log('Correo del usuario:', this.currentUser?.correo);
  ...
  ngAfterViewInit(): void {
    ...
    if (this.currentUser) {
      ...
      // Manejar tanto 'correo' como 'email' para compatibilidad con datos antiguos
      const correo = userAny.correo || userAny.email || (this.currentUser as any).correo;
      if (correo && correo.trim() !== '') {
        this.displayEmail = correo;
        this.userEmail = correo;
        console.log('DisplayCorreo actualizado en ngAfterViewInit:', this.displayEmail);
      }
    }
  }
  ...
  setUserEmail(): void {
    ...
    if (correo && correo.trim() !== '') {
      this.userEmail = correo;
      this.displayEmail = correo;
      console.log('Correo establecido:', this.userEmail);
      console.log('DisplayCorreo establecido:', this.displayEmail);
    } else {
      this.userEmail = 'No disponible';
      this.displayEmail = 'No disponible';
      console.log('No se pudo establecer el correo');
    }
  }
